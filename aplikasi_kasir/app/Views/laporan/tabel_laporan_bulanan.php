    ...
    <div class="col-12">
        ...
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <td class="text-right">Rp. <?= $databulanan == null ? '' : number_format(array_sum($grandtotal), 0)  ?></td>
                <td class="text-right">Rp. <?= $databulanan == null ? '' : number_format(array_sum($untung), 0)  ?></td>
            </tr>
        </table>
    </div>
</div>