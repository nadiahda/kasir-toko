                    ...
                    foreach ($user as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?php
                                ...
                                <?php } else if ($value['level'] == 'Kasir') { ?>
                                    <span class="badge bg-black">Kasir</span>
                                <?php } ?>
                            </td>
                            <td class="text-center">
                                <button class="btn btn-dark btn-sm " data-toggle="modal" data-target="#edit-data<?= $value['id_user'] ?>"><i class="fas fa-pencil-alt"></i></button>
                                <button class="btn btn-danger btn-sm " data-toggle="modal" data-target="#hapus-data<?= $value['id_user'] ?>"><i class="fas fa-trash-alt"></i></button>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="from-group">
                        <label for="">Nama User</label>
                        <input type="text" name="nama" value="<?= $value['nama'] ?>" class="form-control" placeholder="nama" required>
                    </div>
                    <div class="from-group">
                        <label for="">Email</label>
                    ...
                    <div class="form-group">
                        <label>Level</label>
                        <select class="form-control" name="level">
                            <option value="1" <?= $value['level'] == 'Admin' ? 'Selected' : '' ?>>Admin</option>
                            <option value="2" <?= $value['level'] == 'Kasir' ? 'Selected' : '' ?>>Kasir</option>
                        </select>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Apakah Anda Yakin Hapus <b><?= $value['nama'] ?></b> ?</p>
